...
/*
//FILTER
/*Returns only true evaluations of function 
var filtered = tagMap.filter(function(value, index) {
  return [index].value =="en";
});
console.log(filtered);
*/
console.log(tagMap[1].Language);

// var filtered = [];
// for(var i = 0; i<= tagMap.length-1; i++){
