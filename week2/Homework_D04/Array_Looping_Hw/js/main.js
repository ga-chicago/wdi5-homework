...
// 720 objects in the array

// var variableName = arrayName.filter(function(objectBeingPassed) {
//  return objectBeingPassed.propertyToBeChecked === filterCriteria;
//  })

var englishMap = tagMap.filter(function(language) {
